...
pub const ADJECTIVES: [&str; 66] = [
    "ancient", "autumn", "billowing", "bold", "brave", "bright", "calm", "clever", "cool",
    "crimson", "curly", "damp", "dawn", "delicate", "divine", "dry", "empty", "falling",
    "floral", "fragrant", "frosty", "gentle", "green", "happy", "hidden", "holy", "icy",
    "jolly", "late", "lingering", "little", "lively", "long", "lucky", "misty", "morning",
    "muddy", "nameless", "noisy", "old", "patient", "polished", "proud", "purple", "quiet",
    "rapid", "restless", "rough", "shiny", "shy", "silent", "small", "snowy", "solitary",
    "sparkling", "spring", "still", "summer", "twilight", "wandering", "weathered", "wild",
    "winter", "wispy", "withered", "young",
];

pub const NOUNS: [&str; 67] = [
    "badger", "bird", "breeze", "brook", "bush", "butterfly", "cherry", "cloud", "darkness",
    "dawn", "dew", "dream", "dust", "feather", "field", "fire", "firefly", "flower", "fog",
    "forest", "frog", "frost", "glade", "glitter", "grass", "haze", "hill", "lake", "leaf",
    "lion", "log", "meadow", "moon", "morning", "mountain", "night", "otter", "owl", "paper",
    "pine", "pond", "rain", "resonance", "river", "sea", "shadow", "shape", "silence", "sky",
    "smoke", "snow", "snowflake", "sound", "star", "sun", "sunset", "surf", "thunder", "tree",
