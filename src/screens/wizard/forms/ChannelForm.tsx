  ...
  return (
    <div className="h-full w-full my-7 flex flex-col">
      ...
      <div className="font-light text-2xl mt-4">
        Lets choose your Deployment channel
      </div>
      <div className="mb-2 text-justify mt-4 max-w-xl">
        An Arkitekt deployment comes in different flavours, that are
        ...
        frozen in time. Below find currently available versions of Arkitekt.
      </div>
